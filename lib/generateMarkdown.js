...
function intern(object) {
    ...
    const internObject =
        ...
        <div class="card-body">
            ...
            <p class="card-text">ID: ${object.id}</p>
            <p class="card-text">Email: ${object.email}</p>
            <p class="card-text">Office Number: ${object.school}</p>
        </div>
    </div>
    </div>`
...
function engineer(object) {
    ...
    const engineerObject =
        ...
        <div class="card-body">
            ...
            <p class="card-text">ID: ${object.id}</p>
            <p class="card-text">Email: ${object.email}</p>
            <p class="card-text">Office Number: ${object.gitHubUsername}</p>
        </div>
    </div>
    </div>`
...
function generateMarkdown(data) {
    ...
    <div class="jumbotron jumbotron-fluid">
        ...
        <p class="lead">View your teammate's information below.</p>
    </div>
    </div>
    </header>
    <div class='container'>
